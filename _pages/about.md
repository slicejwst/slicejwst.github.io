...
<figure class="figure-center">
  <img src="/assets/images/parent_sample.png" alt="Cluster mass versus redshift, showing SLICE targets against the parent sample from SZ and X-ray catalogs." style="max-width: 600px; width: 100%;">
...
Our sample that spans > 8 Gyr of evolution through cosmic time - this means we can study the buildup of the stellar content in galaxy clusters.

Stellar content comes in the form of three cluster constituents:
